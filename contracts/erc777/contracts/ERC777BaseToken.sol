...
contract ERC777BaseToken is ERC777Token, ERC820Client {
    ...
    /// @param _preventLocking `true` if you want this function to throw when tokens are sent to a contract not implementing `ERC777tokensRecipient`.
    ...
    /// @param _operatorData Data generated by the operator to be passed to the recipient
    ///  ERC777 native Send functions MUST set this parameter to `true`, and backwards compatible ERC20 transfer functions SHOULD set this parameter to `false`.
    function callSender(address _operator, address _from, address _to, uint256 _amount, bytes memory _data, bytes memory _operatorData) internal {
